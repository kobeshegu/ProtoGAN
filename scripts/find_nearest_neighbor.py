...
epoch = 50000
ckpt = '../train_results/wuzhen/models/all_%d.pth'%(epoch)
...
data_root = '/home/y45190302/YMP/ICLR2021/FastGAN-pytorch/train_results/wuzhen/eval_200050000/'
dataset = ImageFolder(root=data_root, transform=trans)

oringinal_datasets = "/home/y45190302/YMP/ICLR2021/FastGAN-pytorch/datasets/wuzhen"
oringinal_data = ImageFolder(root=oringinal_datasets, transform=trans)

import lpips
percept = lpips.PerceptualLoss(model='net-lin', net='vgg', use_gpu=True)

score = percept(oringinal_data, dataset).sum()
print(score)
...
# import lpips
# percept = lpips.PerceptualLoss(model='net-lin', net='vgg', use_gpu=True)
# score = percept(gen_iamge, real_image).sum()